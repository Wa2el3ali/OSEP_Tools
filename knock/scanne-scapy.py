## Usage:
## sudo python scanner.py -P tcp -p 1-1024 -t 192.168.1.1
## sudo python scanner.py -P udp -p 53 -t 8.8.8.8 --threads 50 --timeout 3
## sudo python scanner.py -P both -p 22 -t 192.168.1.0/24 -o results.csv
